                  ...
                  <Tooltip.Trigger asChild>
                    <button 
                      ...
                      className={`px-3 flex items-center h-full rounded text-[9px] font-black uppercase transition-all duration-200 ${
                        algorithm === algo 
                        ? 'bg-indigo-600 text-zinc-100 shadow-md border border-indigo-500/20' 
                    ...
                    <Tooltip.Trigger asChild>
                      <button 
                        ...
                        className={`px-3 flex items-center h-full rounded text-[8px] font-black uppercase transition-all duration-200 ${
                          ...
                          ? 'bg-emerald-600 text-zinc-100 shadow-[0_0_8px_rgba(16,185,129,0.3)] border border-emerald-500/20' 
                          : 'text-zinc-500 hover:text-zinc-300 hover:bg-zinc-800'
                        }`}
                      >
                        {strat.replace('_', ' ')}
             ...
             <Tooltip.Trigger asChild>
               <div className="flex bg-zinc-900/50 p-0.5 rounded-lg border border-zinc-800/50 gap-0.5 h-8 items-stretch">
                 <button 
                   ...
                   className={`flex items-center gap-2 px-3 rounded-md text-[9px] font-black uppercase tracking-widest transition-all ${isAutoPlay ? 'bg-rose-600 text-zinc-100 shadow-md' : 'bg-emerald-600 text-zinc-100 hover:bg-emerald-500 shadow-md shadow-emerald-900/20'}`}
                 >
                 ...
                 <button 
                  onClick={cycleSpeed}
                  className={`flex items-center px-2 rounded-md text-[9px] font-black transition-all ${playbackSpeed > 1 ? 'bg-indigo-600 text-zinc-100' : 'bg-zinc-800 text-zinc-400 hover:bg-zinc-700'}`}
                 >
                   {playbackSpeed}x
                 </button>
               </div>
